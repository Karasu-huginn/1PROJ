...
def normal_or_blitz():
    ...
    while True:
        ...
        rect_jeu_normal = afficher_texte(fenetre,"1. Mode Normal (3 alignements)", 50, hauteur_fenetre // 2.5 + 50, NOIR, police_hover if 50 < mouse_x < 50 + police_hover.size("1. Mode Normal (3 alignements)")[0] and hauteur_fenetre // 2.5 + 50 < mouse_y < hauteur_fenetre // 2.5 + 50 + police_hover.size("1. Mode Normal (3 alignements)")[1] else police)
        rect_jeu_blitz = afficher_texte(fenetre,"2. Mode Blitz (1 alignement)", 50, hauteur_fenetre // 2.5 + 100 + 30, NOIR, police_hover if 50 < mouse_x < 50 + police_hover.size("2. Mode Blitz (1 alignement)")[0] and hauteur_fenetre // 2.5 + 100 + 30 < mouse_y < hauteur_fenetre // 2.5 + 100 + 30 + police_hover.size("2. Mode Blitz (1 alignement)")[1] else police)
